...
class EncryptedCustomResource(AWSCustomObject):
...
EncryptedCustomResource = t.add_resource(EncryptedCustomResource(
...
KMSKeyArn = t.add_output(Output("KmsKeyArn", Value=GetAtt("KMSKey", "Arn")))


EncryptedCustomResourceCipherText = t.add_output(Output(
    "EncryptedCustomResourceCipherText",
    Value=GetAtt("EncryptedCustomResource", "CipherText"),
