...
def main(template, N=1, names=None):
    ...
    for encrypted_param_num in xrange(module.params['N']):
        if module.params['names']:
            if module.params['names'][0] == '[' and module.params['names'][-1] == ']':
                encrypted_param_name = module.params['names'][1:-1].split()[encrypted_param_num]
            else:
    ...
    module.exit_json(changed=True, meta=t.to_json())
...
if __name__ == '__main__':
    ...
    main(t, args.num_sercret_params, args.param_names)
